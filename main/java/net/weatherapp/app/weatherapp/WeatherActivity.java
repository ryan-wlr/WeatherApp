...
import net.weatherapp.app.weatherapp.data.Condition;
import net.weatherapp.app.weatherapp.data.LocationResult;
import net.weatherapp.app.weatherapp.listener.GeocodingServiceListener;
import net.weatherapp.app.weatherapp.listener.WeatherServiceListener;
import net.weatherapp.app.weatherapp.service.WeatherCacheService;
import net.weatherapp.app.weatherapp.service.GoogleMapsGeocodingService;
import net.weatherapp.app.weatherapp.service.YahooWeatherService;
